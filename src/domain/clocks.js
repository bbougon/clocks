...
Clocks.prototype.tokyo = function () {
    return this.sameInstant(ZoneId.of("Asia/Tokyo"));
};

Clocks.prototype.moscow = function () {
    return this.sameInstant(ZoneId.of("Europe/Moscow"));
};

Clocks.prototype.paris = function () {
    return this.sameInstant(ZoneId.of('Europe/Paris'));
};

Clocks.prototype.london = function () {
    return this.sameInstant(ZoneId.of('Europe/London'));
};

Clocks.prototype.newYork = function () {
    return this.sameInstant(ZoneId.of('America/New_York'));
};

Clocks.prototype.losAngeles = function () {
    return this.sameInstant(ZoneId.of('America/Los_Angeles'));
};

Clocks.prototype.saoPaulo = function () {
    return this.sameInstant(ZoneId.of('America/Sao_Paulo'));
};
